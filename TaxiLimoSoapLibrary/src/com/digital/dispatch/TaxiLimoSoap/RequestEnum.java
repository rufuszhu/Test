...
public enum RequestEnum {
	...
	SendDriverMsg("SendDriverMessageReq"), Tokenization("TokenizationRequest"), VerifySMS("VerifyDeviceRequest"), GetServiceList("GetServiceListRequest"),
    AvailableCars("AvailableCarsReq");
