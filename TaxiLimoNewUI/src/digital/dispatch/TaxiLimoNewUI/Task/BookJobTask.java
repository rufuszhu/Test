        ...
        if (resWrapper.getStatus() == 3) {
            ...
            switch (resWrapper.getErrCode()) {
                ...
                case 41:
                    ...
                    break;
                case 1:
                    showMeesageAndGoToProfile(_context.getString(R.string.err_user_unknown));
                    break;
                case 42:
...
//                    break;
    ...
    private void showMeesageAndGoToProfile(String message) {
        ...
        builder.setMessage(message).setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                intent.putExtra(MBDefinition.EXTRA_AUTO_RECOVERY, true);
                ((BookActivity) _context).startActivityForAnim(intent);
            }
        });
